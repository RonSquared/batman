...
command = gets.chomp
	if command == "print all"
		...
		while @characters.has_key?(person1) == false || @characters.has_key?(person2) == false do
			
			puts "I don't know who these people are... Let's try again, who do you want to fight?"
